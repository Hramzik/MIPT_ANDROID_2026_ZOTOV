package com.example.messenger.chats.api
...
import com.example.messenger.chats.internal.ChatsFilterAdapter
import com.example.messenger.chats.internal.ChatsPagingAdapter
import com.example.messenger.chats.internal.ChatsViewModel
import com.example.messenger.chats.internal.CreateChatDialogFragment
import com.example.messenger.messages.api.MessagesFragment
...
class ChatsFragment : Fragment() {
    ...
    private fun initAdapters() {
        val onChatClick: (Chat) -> Unit = { chat ->
            mainVm.select(chat.id)
            if (resources.configuration.orientation == android.content.res.Configuration.ORIENTATION_PORTRAIT) {
                parentFragmentManager.beginTransaction()
                    .replace(com.example.messenger.core.R.id.fragment_container, MessagesFragment())
                    .addToBackStack(null)
                    .commit()
            }
        }
