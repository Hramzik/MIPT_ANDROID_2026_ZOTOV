...
class CreateChatDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val view: View = inflater.inflate(R.layout.dialog_create_chat, null)
        val editName: EditText = view.findViewById(R.id.editChatName)
        val progress: ProgressBar = view.findViewById(R.id.progressCreatingChat)
